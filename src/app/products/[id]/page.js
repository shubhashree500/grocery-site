...
const ProductDetail = ({ params }) => {
  ...
  const productData = {
    1: { id: 1, name: 'Rice, Atta And Dal', price: '$20', images: ['/rice/rice1.jpg', '/rice/rice2.jpg'], description: 'High quality rice and dal package.', category: 'Rice' },
    2: { id: 2, name: 'Fruits And Vegetables', price: '$15', images: ['/fruits/apple.jpg', '/fruits/banana.jpg', '/fruits/orange.jpg'], description: 'Fresh and organic fruits and vegetables.', category: 'Fruits' },
    3: { id: 3, name: 'Oil, Masala, Sauces', price: '$18', images: ['/oil/oil1.jpg', '/oil/oil2.jpg'], description: 'Essential oils, spices, and sauces for your cooking needs.', category: 'Spices' },
    4: { id: 4, name: 'Breakfast Food', price: '$25', images: ['/breakfast/dryfruits.jpg', '/breakfast/dryfruits.jpg'], description: 'Healthy breakfast options.', category: 'Breakfast' },
    ...
    7: { id: 7, name: 'Cleaning Household', price: '$12', images: ['/cleaning/wash.webp'], description: 'Effective cleaning household supplies.', category: 'Cleaning' },
    ...
    9: { id: 9, name: 'Bath Body', price: '$18', images: ['/bathbody/bathing.webp'], description: 'Luxury bath and body essentials.', category: 'Body Care' },
